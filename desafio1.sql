...
CREATE TABLE planos(
    ...
    VALOR_PLANO DECIMAL(7, 2) NOT NULL DEFAULT 0 -- https://dev.mysql.com/doc/refman/8.0/en/fixed-point-types.html
) engine = InnoDB;
...
CREATE TABLE artistas(
    ...
    NOME_ARTISTA VARCHAR(45) NOT NULL DEFAULT 'Artista Desconhecido'
) engine = InnoDB;
...
CREATE TABLE usuarios(
    ...
    NOME_USUARIO VARCHAR(45) NOT NULL DEFAULT 'Sem nome',
    IDADE INTEGER NOT NULL DEFAULT 18,
    ID_PLANO INTEGER NOT NULL DEFAULT 1,
    FOREIGN KEY (ID_PLANO) REFERENCES planos(ID_PLANO) ON DELETE CASCADE -- https://www.techonthenet.com/sql_server/foreign_keys/foreign_delete.php e https://app.betrybe.com/course/back-end/funcoes-sql-joins-e-normalizacao/transformando-ideias-em-um-modelo-de-banco-de-dados/a7326a61-117a-4d2f-a640-9e312b6f973b/conteudos/8c710d4b-8822-4efb-bf55-ed797c0fba48/database-design-como-modelar-um-banco-de-dados/d3d8e2a3-46f8-4766-929b-7756dc2aa838?use_case=side_bar (ultimo vídeo 'Criando tabelas')
) engine = InnoDB;
...
INSERT INTO artistas_seguidos (ID_USUARIO, ID_ARTISTA)
VALUES
  (1, 1),
  (1, 4),
  (1, 3),
...
CREATE TABLE albuns(
    ...
    NOME_ALBUM VARCHAR(45) NOT NULL DEFAULT 'Sem nome',
    ID_ARTISTA INTEGER NOT NULL DEFAULT 1,
    FOREIGN KEY (ID_ARTISTA) REFERENCES artistas(ID_ARTISTA) ON DELETE CASCADE,
...
CREATE TABLE cancoes(
    ...
    NOME_CANCAO VARCHAR(45) NOT NULL DEFAULT 'Sem nome',
    DURACAO_CANCAO_SEGUNDOS INTEGER NOT NULL DEFAULT 1,
...
CREATE TABLE musicas_reproduzidas(
    ...
    FOREIGN KEY (ID_USUARIO) REFERENCES usuarios(ID_USUARIO) ON DELETE CASCADE,
    FOREIGN KEY (ID_CANCAO) REFERENCES cancoes(ID_CANCAO) ON DELETE CASCADE
) engine = InnoDB;
